...
<div class="alert alert-default text-center title-box" style="margin:10px 4px 0 4px;padding:0" id="domaintip">  <div class="dropdown title">视频分类：{type_name}</div></div>
	 {video_list:20}
<div class="video" id="v_VuHKbdWnH2">
    <a href=" {list_view}">
        <div class="vimg">
            <img src="{list_pic}">
            <span class="vlen">上架时间：{list_time}</span><span class="icon_promote icon_promote_right" style="width:100%;height:100%"><span>{type_name}</span></span>
        </div>
