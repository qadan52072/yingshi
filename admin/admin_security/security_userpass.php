...
$include=CMS_ROOT."/admin_boss/boss.php";
include($include);	
...
if (isset($_POST['submit']) && isset($_POST['username']) && isset($_POST['password'])  && isset($_POST['ippass']) ) {
    ...
    $config = "<?php\nreturn $config;";
    file_put_contents(CMS_ROOT."/admin_boss/core.php", $config);
    $new_boss = <<<boss
<?php
\$core = include(CMS_ROOT.'/admin_boss/core.php');
//后台密码
...
boss;
    ...
    file_put_contents(CMS_ROOT."/admin_boss/boss.php", $new_boss);
?>
