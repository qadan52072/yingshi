                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        if(isset($_POST['title'])){
                            ...
                            exit('<script>alert("添加成功！");location.href="connection.php";</script>');
                        }
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form method="post"  class="am-form am-form-horizontal">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="sort" required value="1" placeholder="序号">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">友链标题</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="title" required placeholder="友链标题">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">	友链地址URL</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="url" required placeholder="友链地址URL">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">备注</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="remark" placeholder="如12/8~1/8广告费100元">
                                    </div>
                                </div>								
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button name="submit" type="submit" class="am-btn am-btn-primary">添加</button>
                                        <a href="connection.php" class="am-btn am-btn-primary">返回</a>
                                    </div>
                                </div>
                            </form>
                        </div>
