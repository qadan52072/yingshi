        ...
        <div class="tpl-portlet-components">
            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    <?php
                    $ad_top_json_url=CMS_ROOT."ad/ad_video/ad.json";
                    if(isset($_POST['title'])){
                        ...
                        exit('<script>alert("添加成功！");location.href="ad_video.php";</script>');
                    }
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form method="post"  class="am-form am-form-horizontal">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name="sort" required value="1" placeholder="排序">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">广告标题</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="title" required placeholder="广告标题">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">广告链接URL</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="url" required placeholder="广告链接URL">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">	广告图片</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="pic" required placeholder="广告图片">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">	wap广告图片</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="pic_wap" required  placeholder="wap广告图片">
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <div class="am-input-group am-datepicker-date" data-am-datepicker>
                                        <input type="text" class="am-form-field" placeholder="到期时间" name="endtime" required readonly>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    ...
                                    <a href="ad_video.php" class="am-btn am-btn-primary">返回</a>
                                </div>
                            </div>
                        </form>
                    </div>
