                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form method="post"  class="am-form am-form-horizontal">
								...
								<div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">每日弹窗广告状态 </label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_md"  value="<?php echo  $ad_top_md;?>" placeholder="破解浏览器拦截|手机访问自动弹目标页">
                                    </div>
                                </div>								
                                <div class="am-form-group">
