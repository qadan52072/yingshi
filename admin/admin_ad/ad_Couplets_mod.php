...
<?php
$ad_top_json_url=CMS_ROOT."ad/ad_Couplets/ad.json";
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
							...
							<div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">对联广告坐标：</label>
                                    <div class="am-u-sm-9">
                                        <?php echo  $str_err_name;?>
                                    </div>
								</div>								
								<div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">对联广告状态 </label>
                                    <div class="am-u-sm-9">
                                        <select  name="ad_top_url_zt" data-am-selected="{searchBox: 1}" style="display: none;">
										   <option  value="<?php echo  $str_err;?>">目前状态：<?php echo  $str_err_names;?></option>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_url"  value="<?php echo  $ad_top_url;?>" placeholder="广告链接URL">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">	广告图片素材地址URL</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="ad_top_pic"  value="<?php echo  $ad_top_pic;?>" placeholder="广告图片素材地址URL">
                                    </div>
                                </div>
                                <div class="am-form-group">
