                            ...
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    if(isset($_GET['id'])){
                                        ...
                                        exit('<script>alert("删除成功！");location.href="ad_video.php";</script>');
                                    }
                                    $json = jsonsort($json);
                                    foreach($json as $key => $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="ad_video_mod.php?id=<?php echo $item['id'];?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
