	...
	<?php include('../admin_config/admin_list.php');;?>
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li>广告设置</li>
				 <li class="am-active">每日弹窗广告</li>
            </ol>
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 每日弹窗广告
                    </div>
...
<?php	
$ad_top_json_url=CMS_ROOT."ad/ad_Popup/ad.json";
...
?>
                                        <tr>
                                            <td><a href="javascript:;">每日弹窗广告</a></td>
                                            <td><?php echo $str_err_names?></td>
                                            <td class="am-hide-sm-only"><?php echo $ad_top_md?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
<a href="ad_Popup_mod.php?id=<?php echo $ad_top_id?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
