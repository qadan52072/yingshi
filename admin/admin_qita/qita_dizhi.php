            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 地址公告设置
                    </div>
                </div>
                <div class="tpl-block ">
...
<?php
 $ad_top_json_url=CMS_ROOT."qita/qita_dizhi.json";
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form method="post"  class="am-form am-form-horizontal">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" value="<?php echo $cms_domain1;?>" name="dizhi1" placeholder="发布地址一">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">发布地址二</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" value="<?php echo $cms_domain2;?>" name="dizhi2" placeholder="发布地址二">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">公告内容</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" value="<?php echo $cms_notice;?>" name="dizhigongao" placeholder="公告内容控制30个字符以内">
                                    </div>
                                </div>
                                <div class="am-form-group">
...
$cms_domain1 = post_input($_POST["dizhi1"]);
$cms_domain2 = post_input($_POST["dizhi2"]);
$cms_notice = post_input($_POST["dizhigongao"]);
$bankinfo["ad_top_id"] = '1544977155';
$bankinfo["ad_top_url"] = $cms_domain1;
$bankinfo["ad_top_pic"] = $cms_domain2 ;
$bankinfo["ad_top_md"] = $cms_notice;
