...
<div class="alert alert-default text-center " style="margin:10px 4px 0 4px;padding:0" id="domaintip">  <div class="dropdown">公告：<?php echo $cms_notice; ?></div></div>
    ...
    <?php foreach ($cms_config['video'] as $item){ $type_name=getTypeById('vod',$item);$type_more=U('vod','type',$item,'1');$data=getListByType('vod',$item,true);$page=1;?>
...
for($x=($page-1) * 10;$x<($page-1) * 10 + 10;$x++){ 
...
?>
            <div class="video" id="v_VuHKbdWnH2">
                <a href=" <?php echo $view;?>">
                    ...
                    <?php echo $time;?></span><span class="icon_promote icon_promote_right"
